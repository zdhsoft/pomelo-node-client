 ...
 * 新的PomeloClient
 */
class CPomeloClient extends _events.EventEmitter {
    constructor() {
        super();
        this.socket = null;
        this.reqId  = 0;
    ...
    request_ex(cb, route, msg) {
        this.request(cb, route, msg);
    }
...
module.exports.CPomeloClient = CPomeloClient;
